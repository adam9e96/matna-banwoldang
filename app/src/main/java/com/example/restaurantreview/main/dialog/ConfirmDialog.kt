...
import com.example.restaurantreview.databinding.DialogConfirmFirebaseDeleteBinding
...
class ConfirmDialog(
    ...
    // 뷰 바인딩 정의
    private var _binding: DialogConfirmFirebaseDeleteBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogConfirmFirebaseDeleteBinding.inflate(inflater, container, false)
