...
interface CancelDialogInterface{
    fun onClickYesButton(id: Int)
}
class CancelDialog(
    cancelDialogInterface: AddRestaurantDataActivity,
    title: String, content: String?, buttonText: String, id: Int
) : DialogFragment() {
    private var _binding: DialogCancelBinding? = null
    private val binding get() = _binding!!
    private var cancelDialogInterface: CancelDialogInterface?= null
    ...
    override fun onCreateView(
        ...
        binding.dialogYesBtn.setOnClickListener {
            this.cancelDialogInterface?.onClickYesButton(id!!)
            dismiss()
        }
